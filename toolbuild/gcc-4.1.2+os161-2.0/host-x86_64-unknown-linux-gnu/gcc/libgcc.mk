...
libgcc/./unwind-dw2.o: stmp-dirs ../.././gcc/unwind-dw2.c ../.././gcc/unwind-generic.h unwind-pe.h unwind.inc unwind-dw2-fde.h unwind-dw2.h $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c ../.././gcc/unwind-dw2.c -o libgcc/./unwind-dw2.o
./libgcc.a: libgcc/./unwind-dw2.o
libgcc/./unwind-dw2-fde.o: stmp-dirs ../.././gcc/unwind-dw2-fde.c ../.././gcc/unwind-generic.h unwind-pe.h unwind.inc unwind-dw2-fde.h unwind-dw2.h $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c ../.././gcc/unwind-dw2-fde.c -o libgcc/./unwind-dw2-fde.o
./libgcc.a: libgcc/./unwind-dw2-fde.o
libgcc/./unwind-sjlj.o: stmp-dirs ../.././gcc/unwind-sjlj.c ../.././gcc/unwind-generic.h unwind-pe.h unwind.inc unwind-dw2-fde.h unwind-dw2.h $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c ../.././gcc/unwind-sjlj.c -o libgcc/./unwind-sjlj.o
./libgcc.a: libgcc/./unwind-sjlj.o
libgcc/./gthr-gnat.o: stmp-dirs ../.././gcc/gthr-gnat.c ../.././gcc/unwind-generic.h unwind-pe.h unwind.inc unwind-dw2-fde.h unwind-dw2.h $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c ../.././gcc/gthr-gnat.c -o libgcc/./gthr-gnat.o
./libgcc.a: libgcc/./gthr-gnat.o
libgcc/./unwind-c.o: stmp-dirs ../.././gcc/unwind-c.c ../.././gcc/unwind-generic.h unwind-pe.h unwind.inc unwind-dw2-fde.h unwind-dw2.h $(CONFIG_H) coretypes.h $(TM_H) $(MACHMODE_H) longlong.h config.status stmp-int-hdrs tsystem.h
	$(GCC_FOR_TARGET) $(LIBGCC2_CFLAGS) $(INCLUDES) $(vis_hide) -fexceptions -c ../.././gcc/unwind-c.c -o libgcc/./unwind-c.o
