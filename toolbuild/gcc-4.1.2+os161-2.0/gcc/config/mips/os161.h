/* Definitions of target machine for GNU compiler, for MIPS OS/161 systems.
   (From netbsd.h)
...
#define MACHINE_TYPE "OS/161-mipseb ELF"
#else
#define MACHINE_TYPE "OS/161-mipsel ELF"
#endif
...
/* The generic MIPS TARGET_CPU_CPP_BUILTINS are incorrect for OS/161.
...
#define SUBTARGET_EXTRA_SPECS						\
  ...
  { "os161_link_spec",		OS161_LINK_SPEC_ELF },			\
  { "os161_entry_point",	OS161_ENTRY_POINT },

/* Provide a SUBTARGET_CPP_SPEC appropriate for OS/161.  */

#undef SUBTARGET_CPP_SPEC
#define SUBTARGET_CPP_SPEC "%(os161_cpp_spec)"

/* Provide a LINK_SPEC appropriate for a OS/161-mips target.
   This is a copy of LINK_SPEC from <os161-elf.h> tweaked for
   the MIPS target.  */
